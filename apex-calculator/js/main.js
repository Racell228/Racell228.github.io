(function ($) {
    ...
    $(".select_l").click(function() {
        ...
        $('.leter_back').css({"display":"inline-block"});
    ...
    $("#ia_auc").click(function() {
        ...
        $("#cop_auc,#ia_auc,#man_auc").css("opacity","0.4");
...
// Map
function initMap() {
    var centerCoordinates = {lat: 41.120941, lng: -28.327480},
        georgiaCoordinates = {lat: 32.0785908, lng: -81.0914666},
        lvovCoordinates = {lat: 49.8608625, lng: 24.044312},
        odessaCoordinates = {lat: 46.4798974, lng: 30.7364569},
        krivoyrogCoordinates = {lat: 47.9024331, lng: 33.3924534},
        zoom = 4,
        ...
        markerGeorgia = new google.maps.Marker({
            position: georgiaCoordinates,
            map: map
        }),

        markerLvov = new google.maps.Marker({
            position: lvovCoordinates,
            map: map
        }),

        markerOdessa = new google.maps.Marker({
            position: odessaCoordinates,
            map: map
        });

        markerKrivoyrog = new google.maps.Marker({
            position: krivoyrogCoordinates,
            map: map
        });
