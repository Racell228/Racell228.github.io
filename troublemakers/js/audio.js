...
;(function($, window, document, undefined) {
	...
	if (!$('#ppq-audio-player-style').length) {
		var style = '<style id="ppq-audio-player-style" type="text/css">\
			...
			.ppq-audio-player .play-pause-btn .play-pause-icon:after,.ppq-audio-player.player-playing .play-pause-icon:after{background-image:url(img/play-pause.svg);background-size:60rem;}\
			.ppq-audio-player{position:relative;}\
			.ppq-audio-player audio{position:absolute;vertical-align:baseline}\
			.ppq-audio-player .play-pause-btn{float:left;}\
			.ppq-audio-player .play-pause-btn .play-pause-icon{position:relative;display:block;}\
			.ppq-audio-player .play-pause-btn .play-pause-icon:after{display:block;content:"";background-position:0 0;width:60rem;height:60rem}\
			.ppq-audio-player.player-playing .play-pause-icon:after{background-position:bottom;width:60rem;height:60rem}\
			...
			.ppq-audio-player .player-bar{position:relative;background-color:#fff}\
			...
			.ppq-audio-player .player-bar .player-bar-played{position:absolute;top:0;left:0;width:0;height:100%;border-radius:3px;}\
			</style>';
		$('body').prepend(style);
	}
