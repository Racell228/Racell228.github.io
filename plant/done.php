...
$offer = "Рослини хижаки"; //Что передаем на сервер
...
<p style="text-align:center; margin-top: 50px;"><span style="font-size:28px"><span style="font-family:Trebuchet MS,Helvetica,sans-serif"><span style="color:#000000"><span style="color:#808080"><?php echo $line2 ?></span></span></span></span></p>

<div><a class="btn" style="width: 315px; margin: auto; margin-top: 50px;" href="index.html">Повернутись на головну</a><br></div>
</body>
</html>